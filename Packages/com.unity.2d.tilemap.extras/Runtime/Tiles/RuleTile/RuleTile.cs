    ...
    public class RuleTile : TileBase
    {
        ...
        public class TilingRuleOutput
        {
            ...
            public class Neighbor
            {
                ...
                /// <summary>
                /// The Rule Tile will check if the contents of the cell in that direction is an instance of this Rule Tile group.
                /// If not, the rule will fail.
                /// </summary>
                public const int ThisGroup = 3;
                /// <summary>
                /// The Rule Tile will check if the contents of the cell in that direction is not an instance of this Rule Tile group.
                /// If it is, the rule will fail.
                /// </summary>
                public const int NotThisGroup = 4;
            }
        ...
        public virtual bool RuleMatch(int neighbor, TileBase other)
        {
            ...
            RuleTile ruleTile = other as RuleTile;
            switch (neighbor)
            {
                case TilingRule.Neighbor.This: return other == this;
                case TilingRule.Neighbor.NotThis: return other != this;
                case TilingRule.Neighbor.ThisGroup: return ruleTile != null && ruleTile.group == group;
                case TilingRule.Neighbor.NotThisGroup: return ruleTile == null || ruleTile.group != group;
            }
            return true;
        }
